  ...
  tabPanel(title,
           ...
           fluidRow(
             ...
             mainPanel(
               width = 8,
               fluidRow(
                 column(9, h4("View the Prediction")),
               ...
               tags$br(),
               fluidRow(
                 column(4, savePlotUI(ns("savingPlot"), label = "Save plot")),
                 column(4,
                        fluidRow(
                          column(8,
               ...
               fluidRow(
                 column(
                   4,
                   selectInput(
                     inputId = ns("centerType"),
                     label = "Select estimation",
                     choices = c(
                       "Mean estimation" = "Estimation",
...
runModel <- function(input, output, session, loadedFiles) {
  ...
  currentDataSelection <-
    list(
      xColumns = reactiveVal(defaultColSelection()),
  ...
  dataSelection <- callModule(dataSettings,
                              "settings",
  ...
  modelParameters <- callModule(modelSettings,
                                "modSettings",
  ...
  observe({
    ...
    plotValues$plottedTypeOfPrediction <-
      list(
